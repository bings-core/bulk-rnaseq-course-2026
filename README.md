...
| #  | Date         | Time         | Location   | Topic | Material |
|----|--------------|--------------|------------|------------------------------------------------|--------|
...
Slides (and the R script for hands-on sessions) are linked in the **Material** column and are posted after each session. They open in Microsoft 365 with your Sinai account.
